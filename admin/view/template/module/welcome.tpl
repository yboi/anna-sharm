      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-module-<?php echo $module_row; ?>" class="vtabs-content">
          ...
          <table class="form">
			...
			<tr>
              <td>Назва модуля:</td>
              <td><input type="text" name="welcome_module[<?php echo $module_row; ?>][label]" value="<?php echo $module['label']; ?>" size="30" /></td>
            </tr>
...
function addModule() {	
	...
	html += '    <tr>';
	html += '      <td>Назва модуля:</td>';
	html += '      <td><input type="text" name="welcome_module[' + module_row + '][label]" value="" size="30" /></td>';
	html += '    </tr>';
