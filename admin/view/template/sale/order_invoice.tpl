...
<div style="page-break-after: always;">
  ...
  <table class="store" align="center">
	<tr>
	  <td colspan="2">
  ...
  <table class="product" align="center">
	...
	<tr>
      <td align="right" colspan="3"> <b><?php echo $column_comment; ?></b></td>
      <td align="left" colspan="2"> <?php echo $order['comment']; ?> </td>
    </tr>
	<?php } ?>	
  
	<tr>
      <td align="right" colspan="3"><br><br><br><br><br>  <b><?php echo $text_vudav; ?> </b> _________________________ </td>
      <td align="left" colspan="2"><br><br><br><br><br>   <b><?php echo $text_otrumav; ?> </b> ________________________ </td>
    </tr>
  </table>
