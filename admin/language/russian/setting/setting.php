...
$_['entry_order_edit']         		= 'Период редактирования заказов:<br /><span class="help">Количество дней для возможности редактирования заказов. Это необходимо для того, чтобы не повредить целостность заказа при его редактировании, так как цены и скидки могут меняться с течением времени.</span>';
...
$_['entry_fraud_detection']    		= 'Использовать сервис MaxMind для обнаружения мошенничества в системе:<br /><span class="help">MaxMind - сервис обслуживания обнаружений мошенничества. Если у вас нет лицензионного ключа вы можете пройти регистрацию и <a onclick="window.open(\'http://www.maxmind.com/?rId=opencart\');"><u>получить ключ</u></a>. После того как вы получили ключ, скопируйте его и вставьте в поле ниже.</span>';
$_['entry_fraud_key']          		= 'Лицензионный ключ:</span>';
$_['entry_fraud_score']        		= 'Оценка риска:<br /><span class="help">Чем выше число, тем больше заказ является мошенническим. Установите число между 0 - 100.</span>';
$_['entry_fraud_status']       		= 'Статус заказа при мошенничестве:<br /><span class="help">Заказам будет присвоен этот статус и он не сможет достичь полного статуса автоматически.</span>';
