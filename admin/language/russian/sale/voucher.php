...
$_['error_exists']      = 'Код подарочного сертификата уже используется!';
...
$_['error_order']       = 'Этот подарочный сертификат не может быть удален, так как является частью <a href="%s">заказа</a>!';
?>
