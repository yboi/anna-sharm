...
$_['text_voucher']                            	= 'Добавить подарочный сертификат(ы)';
$_['text_order']                              	= 'Детали заказа';
$_['text_generate']                           	= 'Создать счет-фактуру №';
...
$_['text_error']                              = 'Ошибка:<br /><span class="help">Returns an error string with a warning message or a reason why the request failed.</span>';
